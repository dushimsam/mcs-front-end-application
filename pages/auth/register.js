...
export default function Register() {
    ...
    const register = async () => {
        ...
        try {
            let new_user_form = Object.assign(user_form)
             delete new_user_form.studentClass;
             delete new_user_form.stdFirstName;
            delete new_user_form.stdLastName;
            delete new_user_form.studentCode;
             delete new_user_form.residence;

            const user_res = await UserService.create(user_form);
            let new_par_form = Object.assign(parent_form);
            new_par_form.userId = user_res.data.id;
            new_par_form.phone = user_res.phone;

            delete new_par_form.firstName
            delete new_par_form.lastName;
            delete new_par_form.email;
            delete new_par_form.password;
            delete new_par_form.userName;
            ...
            new_std_form.parentId = parent_res.data.id;
    ...
    const handleFormChange = (prop,statusForm) => async (event) => {
        ...
        if(statusForm ==="USER")
        {
            ...
            validator = new Validator(user_form, validations);
        }else if(statusForm ==="PARENT"){
            setParentForm({...parent_form, [prop]: event.target.value});
             validator = new Validator(parent_form, validations);
        }else{
            setStudentForm({...student_form, [prop]: event.target.value});
            validator = new Validator(student_form, validations);
        }
    ...
    return (
        <div className={styles.root}>
            ...
            >
                ...
                <div className={"mb-5"}>
                    {alertData.alert ? (
                        <Alert message={alertData.message} className={alertData.class} setAlert={setAlertData}/>
                    ) : (
                        <></>
                    )}
                </div>
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <input
                                type="text"
                                id={"user-name"}
                                onChange={handleFormChange("userName","USER")}
                    ...
                    <div className="form-group row">
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <input
                                type="text"
                                id={"first-name"}
                                onChange={handleFormChange("firstName","USER")}
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <input
                                type="text"
                                id={"last-name"}
                                onChange={handleFormChange("lastName","USER")}
                    ...
                    <div className="form-group row">
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <input
                                type="text"
                                id={"email"}
                                onChange={handleFormChange("email","USER")}
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <input
                                type="text"
                                id={"phone"}
                                onChange={handleFormChange("phone","USER")}
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3">
                            ...
                            <input
                                type="text"
                                id={"residence"}
                                onChange={handleFormChange("residence","PARENT")}
                    ...
                    <div className="form-group row">
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <input
                                type="password"
                                id={"password"}
                                onChange={handleFormChange("password","USER")}
                    ...
                    <div className="form-group row mt-5">
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <input
                                type="text"
                                id={"stdFirstName"}
                                onChange={handleFormChange("stdFirstName","STUDENT")}
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <input
                                type="text"
                                id={"stdLastName"}
                                onChange={handleFormChange("stdLastName","STUDENT")}
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <input
                                type="text"
                                id={"studentClass"}
                                onChange={handleFormChange("studentClass","STUDENT")}
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <input
                                type="text"
                                id={"studentCode"}
                                onChange={handleFormChange("studentCode","STUDENT")}
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <button
                                ...
                                disabled={
                                    ...
                                    Object.values(parent_form).some((o) => o === "") ||
                                    Object.values(student_form).some((o) => o === "") ||
                                    loading
                                }
                                onClick={register}
                            >
