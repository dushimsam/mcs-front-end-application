...
const MessageUtils = ({ showReply, setShowReply }) => {
    return (
        <div className="container mt-3">
            <div className="row justify-content-between">
                <div className="col-3">
                    <button className="btn btn-primary" onClick={() => setShowReply(!showReply)}><span className="mr-3"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18"><path fill="none" d="M0 0H24V24H0z" /><path d="M11 20L1 12l10-8v5c5.523 0 10 4.477 10 10 0 .273-.01.543-.032.81-1.463-2.774-4.33-4.691-7.655-4.805L13 15h-2v5zm-2-7h4.034l.347.007c1.285.043 2.524.31 3.676.766C15.59 12.075 13.42 11 11 11H9V8.161L4.202 12 9 15.839V13z" fill="rgba(255,255,255,1)" /></svg></span><span>Reply</span></button>
                </div>
                <div className="col-3">
                    <button className="btn btn-danger"><span className="mr-3"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18"><path fill="none" d="M0 0h24v24H0z" /><path d="M17 6h5v2h-2v13a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V8H2V6h5V3a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v3zm1 2H6v12h12V8zm-9 3h2v6H9v-6zm4 0h2v6h-2v-6zM9 4v2h6V4H9z" fill="rgba(255,255,255,1)" /></svg></span><span>Delete</span></button>
                </div>
            </div>
        </div>
    )
            ...
            <SingleSubModuleLayoutAdmin
                Content={
                    <div className="container mt-3 mb-5">
                        <div className="row">
                            <MessageContainer showReply={showReply} setShowReply={setShowReply} />
                        </div>
                        <div className="row">
                            {
                                showReply ? <MessageReplyContainer editorState={editorState} onEditorStateChange={onEditorStateChange} /> : <></>
                            }
                        </div>
                    </div>
                }
