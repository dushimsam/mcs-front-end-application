...
import { studentSchema } from "../../../utils/validations/schemas/student";
        ...
        {(formik) => (
          <Form>
            ...
            >
              ...
              <div className="mt-5">
                <button className="btn btn-danger px-4 mr-5 pr-" type="submit">
                  ADD
                </button>
...
const NewStudent = () => {
  ...
  return (
    <SingleSubModuleLayout
      ...
      count={parent.students ? parent.students.length : 0}
