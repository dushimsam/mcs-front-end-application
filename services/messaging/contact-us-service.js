...
class ContactUsService {
    ...
    get_all_paginated(page) {
        return http.get("/contact-us-messages/paginated?size=5&page=" + page);
    }
    ...
    search_paginated(search, page) {
        return http.get(`/contact-us-messages/search/${search}/paginated?&size=5&page=${page}`);
    }
    ...
    getAllByReadStatusPaginated(status, page = 0) {
        return http.get(`/contact-us-messages/is-read/status/${status}/paginated?&size=5&page=${page}`)
    }
    ...
    getAllByRepliedStatusPaginated(status, page = 0) {
        return http.get(`/contact-us-messages/is-replied/status/${status}/paginated?&size=5&page=${page}`)
    }
