...
export default function AdminNavbar({ quickActions, setShowSidebar, sidebarState }) {
    ...
    return (
        <div style={{ height: 50 }} className="shadow-sm d-flex justify-content-between align-items-center px-3 bg-white">
            ...
            <div className="d-flex align-items-center">
                ...
                <div className="dropdown">
                    <div className="account d-flex pl-4 align-items-center cursor-pointer" style={{ fontSize: '14px', color: '#707070', cursor: "pointer" }}
                    ...
                    <div className="dropdown-menu dropdown-menu-right cursor-pointer" aria-labelledby="dropdownMenuButton">
                        <Link href={getDashboardLink(authUser) + "/account/settings"} passHref><a className="dropdown-item" href="#">Account settings</a></Link>
